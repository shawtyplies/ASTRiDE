...
class EDGE:
    ...
    def angle_between(self, edge1, edge2):
        ...
        """
        dx = edge2['x_center'] - edge1['x_center']
        dy = edge2['y_center'] - edge1['y_center']
    ...
    def connect_edges(self, proximity_threshold=5000, angle_range=(0, 5)):
        ...
        for i in range(len(self.edges)):
            ...
            for j in range(i + 1, len(self.edges)):
                ...
                if angle_range[0] <= angle_ij <= angle_range[1]:
                    # Check if the centers are within the proximity threshold.
                    if self.check_center_proximity(edge_i, edge_j, proximity_threshold):
