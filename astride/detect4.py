...
class Streak:
    ...
    def plot_figures(self, cut_threshold=3.):
        ...
        # Plot original image.
        pl.imshow(self.raw_image, origin='upper', cmap='Greys_r')
        ...
        plot_data[np.where(self.image < med - cut_threshold * std)] = \
            med - cut_threshold * std
        pl.clf()
        pl.imshow(plot_data, origin='upper', cmap='gray')
        ...
        if self.image is not None:
            ...
            pl.imshow(image, origin='upper', cmap='Greys_r')
            ...
            if self.wcsinfo:
                ...
                image[image < cut_threshold * self._std] = np.nan
                ax.imshow(image, origin='upper', cmap='Greys_r')
